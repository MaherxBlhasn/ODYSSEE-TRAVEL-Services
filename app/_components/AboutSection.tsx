  ...
  return (
    <section id="about" className="py-20 px-6 relative" style={{
      ...
      <div className="container mx-auto relative z-10">
        ...
        {/* Features with clean design and larger icons - Now with equal heights */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div className="group cursor-pointer text-center h-full">
            <div className="bg-white rounded-3xl p-8 shadow-lg transition-all duration-500 ease-out transform group-hover:-translate-y-3 group-hover:scale-105 group-hover:shadow-2xl h-full flex flex-col">
