    ...
    <section id="contact" className="section-padding bg-navy">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-xl text-beige/80 max-w-2xl mx-auto">{tContact('subtitle')}</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="fade-in">
            <div className="bg-beige/10 rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-beige mb-8">{tContact('info.title')}</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-beige">{tContact('info.address.title')}</h4>
                    <p className="text-beige/80">{tContact('info.address.value')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-beige">{tContact('info.phone.title')}</h4>
                    <p className="text-beige/80">{tContact('info.phone.value')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-beige">{tContact('info.email.title')}</h4>
                    <p className="text-beige/80">{tContact('info.email.value')}</p>
                  </div>
                </div>
              </div>

              <div className="mt-8 pt-8 border-t border-orange/20">
                <h4 className="text-lg font-semibold text-beige mb-4">{tContact('info.followUs')}</h4>
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-orange rounded-full flex items-center justify-center hover:bg-orange/80 transition-colors flex-shrink-0">
